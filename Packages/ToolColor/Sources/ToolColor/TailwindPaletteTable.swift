// Generated from tailwindcss 4.3.3 `packages/tailwindcss/theme.css` (the default palette, 26 hues x 11 steps).
// Values are the stylesheet's own OKLCH triples; lightness as a fraction, hue 0 where the file says `none`.

extension TailwindPalette {
    static let oklchEntries: [(name: String, l: Double, c: Double, h: Double)] = [
        ...
        ("olive-200", 0.93, 0.007, 106.5),
        ("olive-300", 0.88, 0.011, 106.6),
        ("olive-400", 0.737, 0.021, 106.9),
        ("olive-500", 0.58, 0.031, 107.3),
        ...
        ("mist-500", 0.56, 0.021, 213.5),
        ("mist-600", 0.45, 0.017, 213.2),
